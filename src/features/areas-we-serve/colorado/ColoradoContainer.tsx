...
export default function ColoradoContainer() {
    return (
        <main>
            <VideoBanner showSubtitle={true}/>
            <AwardsBanner />

            <RoofingServicesSection title="COLORADO ROOFING SERVICES" imageSrc="/assets/images/features/home/content-v14.webp" />
            <HandleRoofingProjectSection city={"Colorado "}/>
