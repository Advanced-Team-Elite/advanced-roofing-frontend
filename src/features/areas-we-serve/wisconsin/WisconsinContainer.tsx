...
export default function WisconsinContainer() {
    return (
        <main>
            <VideoBanner showSubtitle={true}/>
            <AwardsBanner />

            <RoofingServicesSection title="WISCONSIN ROOFING SERVICES" imageSrc="/assets/images/features/home/content-v14.webp" />
            <HandleRoofingProjectSection city={"Wisconsin "}/>
