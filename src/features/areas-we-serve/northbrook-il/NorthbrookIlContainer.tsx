...
export default function NorthbrookIlContainer() {
    return (
        <main>
            <VideoBanner showSubtitle={true}/>
            <AwardsBanner />

            <RoofingServicesSection title="NORTHBROOK ROOFING SERVICES" imageSrc="/assets/images/features/home/content-v14.webp" />
            <HandleRoofingProjectSection city={"Northbrook "}/>
