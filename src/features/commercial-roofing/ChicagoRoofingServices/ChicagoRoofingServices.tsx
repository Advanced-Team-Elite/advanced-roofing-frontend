                ...
                <div className={styles.textContent}>
                    ...
                    <div className={styles.contactBanner}>
                        <p className={styles.contactText}>
                            Call <a href="tel:8779456565"><strong>(877) 945-6565</strong></a> or <Link href="/contact"><strong className={styles.contactUs}>contact us online</strong></Link> to schedule a service and get a free estimate.
                        </p>
                    </div>
